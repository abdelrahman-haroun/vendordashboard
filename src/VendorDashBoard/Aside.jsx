...
export default function Aside() {
  ...
  const fetchData = async () => {
    try {
      const res = await axios.get(`http://localhost:7000/api/v1/vendors/${id}`);
    ...
    <>
      ...
      >
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
          <a href="#" className="flex items-center pl-2.5 mt-2">
            <img src="./logobg.png" className="h-6 mr-3 sm:h-7" alt="Logo" />
